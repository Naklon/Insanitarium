...
public:
	static vec3 GetPositionAfterWorldCollisions(vec3 pos0, vec3 pos1, GamePlayer &player, vector<SceneObject *> * objects, int step = 0, CCollisionPolygon * exclude = NULL);
